...
Date: [2024-12-12]
Purpose: This DAG script demonstrates how to verify the existance file in GCS bucket to initiate load job in BigQuery
...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='dk1_bucket',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='raydeepak0206.dk1_staging_ds.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV',
